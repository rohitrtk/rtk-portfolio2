...
export default function About() {
  ...
  return (
    <main className="w-full h-full flex flex-col items-center justify-start overflow-x-hidden overflow-y-visible">
      ...
      <a.div style={pageStyle} className="mt-20 w-3/4">
        ...
        <div className="w-full justify-center items-center mt-10 flex md:flex-row flex-col-reverse">
          <section className="flex flex-col gap-6 md:w-1/2 w-full text-center md:text-start md:pb-0">
            {description.map((d, i) => (
              <Typography

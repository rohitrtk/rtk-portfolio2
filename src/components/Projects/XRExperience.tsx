        ...
        <Modal setModalOpen={setModalOpen} modalOpen={modalOpen} title={title}>
          ...
          <div className="w-full text-left p-10 gap-5 [&>*]:m-5">
            <section>
              ...
              <Hyperlink href="https://snpolytechnic.com/">SNP</Hyperlink>, was
              to create a web app for people to learn about Indigenous Culture.
              Users would be able to "vist" various locations in browser and
              walk around to see various points of interest. These points of
              interest would have various assets like videos, audio, or images
              which would explain a topic or object of interest.
            </section>
            ...
            <section>
              ...
              <span className="bg-yellow-300 text-black">
                The project uses primarily JavaScript and aFrame (a virtual
                realiy web framework) contained inside of React components.
                There were 6 locations originally, which upon loading, download
                their media assets from Azure storage.
              </span>
            </section>

            <section>
              Users are initially greeted with a webpage which contains the
              original 6 locations. Upon clicking on a location, a new page
              loads containing the aFrame scene. Users can click on waypoints to
              traverse the scene, and click on points of interest which are
              denoted by a symbol. These points of interest contain a selection
              of media assets pertaining to a particular object or location.
              Users can also navigate to any of the other 5 locations through a
              UI provided.
            </section>

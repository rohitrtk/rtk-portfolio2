      ...
      <Modal setModalOpen={setModalOpen} modalOpen={modalOpen} title={title}>
        ...
        <div className="w-full text-left p-2 gap-5 [&>*]:m-5">
          ...
          <section>
            ...
            then log in, if nit was their first time logging in, they will have
            a message asking for them to change their password (as the password
            is generated by the backend). Users can then enter their personal

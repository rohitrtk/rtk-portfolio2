        ...
        <Modal setModalOpen={setModalOpen} modalOpen={modalOpen} title={title}>
          ...
          <div className="w-full text-left p-2 gap-5 [&>*]:m-5">
            <section>
              ...
              <Hyperlink href="https://www.ouac.on.ca/">OUAC</Hyperlink>, which,
              if you don't live in Ontario or in Canada, is what high school
              students use to apply to various post secondary institutes in
              Ontario. The goal was to have students apply directly to{" "}
            ...
            <section>
              ...
              <span className="bg-yellow-300 text-black">
                ...
                the backend together with HTML, CSS, and JavaScript with help
                from Bootstrap and jQuery on the frontend.
              </span>
            </section>
            ...
            <section>
              ...
              can then log in, if nit was their first time logging in, they will
              have a message asking for them to change their password (as the
              password is generated by the backend). Users can then enter their
              personal information, things such as:

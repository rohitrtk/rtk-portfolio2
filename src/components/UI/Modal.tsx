...
const Modal = forwardRef<HTMLDivElement, Props>(
  ({ title, children, setModalOpen, modalOpen }, ref) => {
    const [transitions, api] = useTransition(modalOpen, () => ({
      from: { opacity: 0 },
      enter: { opacity: 1 },
      leave: { opacity: 0 },
      config: {
    ...
    return (
      <div
        ...
        />
        <a.div className="relative rounded-lg m-auto justify-start items-center flex flex-col bg-neutral-900 w-2/3 h-full overflow-y-scroll">

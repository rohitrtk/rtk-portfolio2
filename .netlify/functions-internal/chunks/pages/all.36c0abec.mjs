...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en">
	...
	<body class="bg-neutral-900 text-gray-400 m-1 scrollbar-hide">
		${renderComponent($$result, "App", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "@components/App.jsx", "client:component-export": "default" })}
	</body></html>`;
